...
import { getVerdictColors, getVerdictLabel, getVerdictIcon, formatConfidence, createProgressBar, createBackdrop, debounce } from './overlay-utils';
let overlayContainer = null;
let shadowRoot = null;
/**
 * Create and show the overlay
 */
export function createOverlay(response) {
 ...
 */
function createOverlayContent(response) {
 ...
 */
function createHeader(response, colors) {
 ...
 */
function createConfidenceSection(confidence, colors) {
 ...
 */
function createReasonsSection(reasons) {
    const section = document.createElement('div');
 ...
 */
function createExplanationSection(response) {
    const section = document.createElement('div');
 ...
 */
function createActionsSection(actions, colors) {
    const section = document.createElement('div');
 ...
 * Create top badge
 */
function createTopBadge(response, colors) {
 ...
 */
function createHighlightBoxes(highlights) {
 ...
 */
function showMagnifier(cropBase64, coords) {
